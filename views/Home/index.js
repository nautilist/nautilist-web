...
function headerMain(){
  ...
  <div class="w-100 flex flex-row-ns flex-column items-center">
    <section class="w-50-ns w-100 flex flex-column h-100 justify-center pa3 pr4 pb5 pb0-ns">
      <h2 class="tl-ns tc b f2-ns f4 ma0 f-subheadline-l measure lh-title">Welcome to <span class="dark-pink">Nautilists</span></h2>
    ...
    <section class="dropshadow bg-white bn h-100 pa3-ns pt3 pb3 w-50-ns w-100 flex flex-row-ns flex-column ba-ns bw1-ns dropshadow-ns b--dark-pink">
